...
class TestTeamRepository:
    def create(self, team, user):
        ...
        return result
    def get_all(self):
        return [{'id':1,'name':'test1','type':1,'description':'test description','pay_level':1},{'id':2,'name':'test2','type':1,'description':'test description','pay_level':1}]
...
def test_get_teams_route():
    ...
    assert response.status_code == 200
    assert response.json() == [{'id':1,'name':'test1','type':1,'description':'test description','pay_level':1},{'id':2,'name':'test2','type':1,'description':'test description','pay_level':1}]
